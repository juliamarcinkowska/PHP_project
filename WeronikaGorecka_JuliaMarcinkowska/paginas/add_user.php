...
<form class="form-signin" action="registration.php" method="post">
    ...
    <select class='custom-select mt-lg-1' name='usertype_select' required>
        <option value='' disabled selected>Choose usertype</option>
    </select>
    <input type="text" name="name" class="form-control mt-lg-1" placeholder="Name" required autofocus>
